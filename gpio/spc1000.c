...
static MACHINE_CONFIG_DERIVED( spc1000a, spc1000 )
//	MCFG_CASSETTE_DEFAULT_STATE(CASSETTE_PLAY | CASSETTE_SPEAKER_MUTED | CASSETTE_MOTOR_DISABLED)
MACHINE_CONFIG_END
...
ROM_START( spc1000a )
	ROM_REGION(0x10000, "maincpu", ROMREGION_ERASEFF)
	ROM_LOAD("spcall.rom", 0x0000, 0x8000, CRC(2184e1c9) SHA1(fd08062ca922ea3ec85cd5cf891ccc9208300d46))
ROM_END
...
COMP( 1984, spc1000a, spc1000,0,       spc1000a,  spc1000, driver_device,  0,   "Samsung", "SPC-1000A", 0 )
