...
CScreenDevice8::CScreenDevice8 (unsigned nWidth, unsigned nHeight, boolean bVirtual)
:	m_nInitWidth (nWidth),
...
CScreenDevice8::~CScreenDevice8 (void)
{
	if (m_bVirtual)
	{
		delete [] m_pBuffer;
...
boolean CScreenDevice8::Initialize (void)
{
	if (!m_bVirtual)
	{
...
unsigned CScreenDevice8::GetWidth (void) const
{
	return m_nWidth;
}

int CScreenDevice8::GetDepth (void) const 
{
	return DEPTH/8;
}

unsigned CScreenDevice8::GetHeight (void) const
{
	return m_nHeight;
}
...
void CScreenDevice8::SetPalette(u8 num, u32 color)
{
	m_pFrameBuffer->SetPalette32(num, color);
}

void CScreenDevice8::UpdatePalette (void)
{
	m_pFrameBuffer->UpdatePalette();
}


unsigned CScreenDevice8::GetColumns (void) const
{
	return m_nWidth / m_CharGen.GetCharWidth ();
}

unsigned CScreenDevice8::GetRows (void) const
{
...
void CScreenDevice8::SetXY(int x, int y)
{
	m_nCursorX = x;
	m_nCursorY = y;
}
...
int CScreenDevice8::Write (const void *pBuffer, unsigned nCount)
{
	m_SpinLock.Acquire ();
...
void CScreenDevice8::Write (char chChar)
{
	switch (m_nState)
	{
...
void CScreenDevice8::CarriageReturn (void)
{
	m_nCursorX = 0;
}

void CScreenDevice8::ClearDisplayEnd (void)
{
	ClearLineEnd ();
...
void CScreenDevice8::ClearLineEnd (void)
{
...
void CScreenDevice8::CursorDown (void)
{
...
void CScreenDevice8::CursorHome (void)
{
	m_nCursorX = 0;
	m_nCursorY = m_nScrollStart;
}

void CScreenDevice8::CursorLeft (void)
{
	if (m_nCursorX > 0)
	{
...
void CScreenDevice8::CursorMove (unsigned nRow, unsigned nColumn)
{
...
void CScreenDevice8::CursorRight (void)
{
	m_nCursorX += m_CharGen.GetCharWidth ();
...
void CScreenDevice8::CursorUp (void)
{
	if (m_nCursorY > m_nScrollStart)
	{
		m_nCursorY -= m_CharGen.GetCharHeight ();
...
void CScreenDevice8::DeleteChars (unsigned nCount)	// TODO
{
}

void CScreenDevice8::DeleteLines (unsigned nCount)	// TODO
{
}

void CScreenDevice8::DisplayChar (char chChar)
{
	// TODO: Insert mode
...
void CScreenDevice8::EraseChars (unsigned nCount)
{
	if (nCount == 0)
	{
		return;
...
void CScreenDevice8::InsertLines (unsigned nCount)	// TODO
{
}

void CScreenDevice8::InsertMode (boolean bBegin)
{
	m_bInsertOn = bBegin;
}

void CScreenDevice8::NewLine (void)
{
	CarriageReturn ();
	CursorDown ();
}

void CScreenDevice8::ReverseScroll (void)
{
	if (   m_nCursorX == 0
	    && m_nCursorY == 0
	)
...
void CScreenDevice8::SetCursorMode (boolean bVisible)
{
	m_bCursorOn = bVisible;
}

void CScreenDevice8::SetScrollRegion (unsigned nStartRow, unsigned nEndRow)
{
...
void CScreenDevice8::SetStandoutMode (unsigned nMode)
{
	switch (nMode)
	{
	case 0:
...
void CScreenDevice8::Tabulator (void)
{
...
void CScreenDevice8::Scroll (void)
{
...
void CScreenDevice8::EraseChar (unsigned nPosX, unsigned nPosY)
{
	for (unsigned y = 0; y < m_CharGen.GetCharHeight (); y++)
	{
		for (unsigned x = 0; x < m_CharGen.GetCharWidth (); x++)
...
void CScreenDevice8::InvertCursor (void)
{
	if (!m_bCursorOn)
	{
		return;
...
void CScreenDevice8::Rotor (unsigned nIndex, unsigned nCount)
{
