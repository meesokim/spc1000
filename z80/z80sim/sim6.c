...
#endif
	//*(ram + IX + data) &= ~1;
	memwrt(ram + IX + data, *(ram + IX + data) & ~1);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
...
#endif
	//*(ram + IX + data) &= ~2;
	memwrt(ram + IX + data, *(ram + IX + data) & ~2);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
...
#endif
	//*(ram + IX + data) &= ~4;
	memwrt(ram + IX + data, *(ram + IX + data) & ~4);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
...
#endif
	//*(ram + IX + data) &= ~16;
	memwrt(ram + IX + data, *(ram + IX + data) & ~16);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
...
#endif
	//*(ram + IX + data) &= ~32;
	memwrt(ram + IX + data, *(ram + IX + data) & ~32);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
