...
#endif
	//*(ram + IY + data) &= ~1;
	memwrt(ram + IY + data, *(ram + IY + data) & ~1);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
...
#endif
	//*(ram + IY + data) &= ~2;
	memwrt(ram + IY + data, *(ram + IY + data) & ~2);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
...
#endif
	//*(ram + IY + data) &= ~4;
	memwrt(ram + IY + data, *(ram + IY + data) & ~4);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
...
#endif
	//*(ram + IY + data) &= ~8;
	memwrt(ram + IY + data, *(ram + IY + data) & ~8);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
...
#endif
	//*(ram + IY + data) &= ~16;
	memwrt(ram + IY + data, *(ram + IY + data) & ~16);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
...
#endif
	//*(ram + IY + data) &= ~32;
	memwrt(ram + IY + data, *(ram + IY + data) & ~32);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
