...
#endif
	//*(ram + (H << 8) + L) |= 128;
	memwrt(ram + (H << 8) + L, *(ram + (H << 8) + L) | 128);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
