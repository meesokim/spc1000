...
static int op_ldxda(void)		/* LD (IX+d),A */
{
	...
	memwrt(ram + IX + (signed char) *PC++, A);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
...
static int op_ldxdb(void)		/* LD (IX+d),B */
{
	...
	memwrt(ram + IX + (signed char) *PC++, B);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
...
static int op_ldxdc(void)		/* LD (IX+d),C */
{
	...
	memwrt(ram + IX + (signed char) *PC++, C);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
...
static int op_ldxdd(void)		/* LD (IX+d),D */
{
	...
	memwrt(ram + IX + (signed char) *PC++, D);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
...
static int op_ldxde(void)		/* LD (IX+d),E */
{
	...
	memwrt(ram + IX + (signed char) *PC++, E);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
...
static int op_ldxdh(void)		/* LD (IX+d),H */
{
	...
	memwrt(ram + IX + (signed char) *PC++, H);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
...
static int op_ldxdl(void)		/* LD (IX+d),L */
{
	...
	memwrt(ram + IX + (signed char) *PC++, L);
#ifdef BUS_8080
	cpu_bus = 0;
#endif
#ifdef FRONTPANEL
