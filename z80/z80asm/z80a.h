...
#define STRSEP2		'\"'	/* another string separator */
#define ENDFILE		"END"	/* end of source */
#define MAXFN		512	/* max. no. source files */
#define MAXLINE		1024	/* max. line length source */
#define PLENGTH		65000	/* default lines/page in listing */
#define SYMSIZE		20	/* max. symbol length */
#define INCNEST		5	/* max. INCLUDE nesting depth */
#define IFNEST		5	/* max IF.. nesting depth */
#define HASHSIZE	5000	/* max. entries in symbol hash array */
