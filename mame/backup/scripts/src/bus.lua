...
if (BUSES["SPC1000"]~=null) then
	files {
		...
		MAME_DIR .. "src/devices/bus/spc1000/tap.cpp",
		MAME_DIR .. "src/devices/bus/spc1000/tap.h",
		MAME_DIR .. "src/devices/bus/spc1000/spcbox.h",
		MAME_DIR .. "src/devices/bus/spc1000/spc1000.bin.inc",
	}
end
