...
if (BUSES["MSX_SLOT"]~=null) then
	files {
		...
		MAME_DIR .. "src/devices/bus/msx/cart/zmxbus.cpp",
		MAME_DIR .. "src/devices/bus/msx/cart/zmxbus.h",
		MAME_DIR .. "src/devices/bus/msx/cart/zmx.cpp",
		MAME_DIR .. "src/devices/bus/msx/cart/zmx.h",
	}
end
